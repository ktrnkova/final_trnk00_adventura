...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazVyndej(herniPlan));
        platnePrikazy.vlozPrikaz(new PrikazVBatohu(herniPlan));
        platnePrikazy.vlozPrikaz(new PrikazOdevzdej(this));
    }
    ...
    public String vratUvitani() {
        return "Vítejte!\n" +
               "V noci se do muzea vloupalo několik zlodějů, policie zloděje chytila, \n" +
               "ovšem pár věcí, které ukradli se nenašli.\n" +
               "Tvým úkolem je najít těchto 5 věcí a vrátit je do muzea.\n" +
               "\nMusíš najít: zlaté vejce, prsten, indiánskou čelenku, trilobita a globus" +
               "\n" + "\n" +
               herniPlan.getAktualniProstor().dlouhyPopis();
    }
    
    /**
     *  Vrátí závěrečnou zprávu pro hráče po skončení hry.
     */
